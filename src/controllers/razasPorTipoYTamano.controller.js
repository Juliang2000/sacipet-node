...
const obtenerPorIdTipoMascotaYTamanio = async(id_tipo_mascota,id_tamanio) => {

    try {
        let respuesta =
            await pool.query('SELECT id_raza, nombre_raza FROM t_razas WHERE id_tipo_mascota = $1 AND id_tamanio = $2', [id_tipo_mascota,id_tamanio]);
        ...
        throw new Error(`Archivo razas.controller.js -> obtenerPorIdTipoMascotaYTamanio()\n${err}`);
    }
}
...
module.exports = {
    obtenerPorIdTipoMascotaYTamanio,
    obtenerPorIdRaza,
